...
+ (NSInteger)Manager_getReadTheme{
    ...
    NSString *themeID = [[NSUserDefaults standardUserDefaults] objectForKey:[NSString stringWithFormat:@"%@Theme",[[CatalogText siged] getBookName]]];
...
+ (void)saveCurrentThemeID:(NSInteger)currentThemeID{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:@(currentThemeID) forKey:[NSString stringWithFormat:@"%@Theme",[[CatalogText siged] getBookName]]];
...
+ (NSUInteger)Manager_getPageBefore{
    ...
    NSString *pageID = [[NSUserDefaults standardUserDefaults] objectForKey:[NSString stringWithFormat:@"%@Page",[[CatalogText siged] getBookName]]];
...
+ (void)saveCurrentPage:(NSInteger)currentPage{
    [[NSUserDefaults standardUserDefaults] setValue:@(currentPage) forKey:[NSString stringWithFormat:@"%@Page",[[CatalogText siged] getBookName]]];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
{
    NSString *chapterID = [[NSUserDefaults standardUserDefaults] objectForKey:[NSString stringWithFormat:@"%@OPEN",[[CatalogText siged] getBookName]]];
    if (chapterID == nil) {
        return 1;
    }else{
...
+ (void)saveCurrentChapter:(NSInteger)currentChapter{
    [[NSUserDefaults standardUserDefaults] setValue:@(currentChapter) forKey:[NSString stringWithFormat:@"%@OPEN",[[CatalogText siged] getBookName]]];
    [[NSUserDefaults standardUserDefaults] synchronize];
...
+ (NSUInteger)fontSize
{
    NSUInteger fontSize = [[NSUserDefaults standardUserDefaults] integerForKey:[NSString stringWithFormat:@"%@FONT_SIZE",[[CatalogText siged] getBookName]]];
    if (fontSize == 0) {
        fontSize = 20;
    }
    return fontSize;
...
{
    [[NSUserDefaults standardUserDefaults] setValue:@(fontSize) forKey:[NSString stringWithFormat:@"%@FONT_SIZE",[[CatalogText siged] getBookName]]];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
+ (void)saveCurrentMark:(NSInteger)currentChapter andChapterRange:(NSRange)chapterRange byChapterContent:(NSString *)chapterContent{
    ...
    if (![self checkIfHasBookmark:chapterRange withChapter:currentChapter]) {//没加书签
        ...
        NSData *data = [[NSUserDefaults standardUserDefaults] objectForKey:[NSString stringWithFormat:@"%@epubBookName",[[CatalogText siged] getBookName]]];
        ...
        if (oldSaveArray.count == 0) {
            ...
            [[NSUserDefaults standardUserDefaults] setObject:[NSKeyedArchiver archivedDataWithRootObject:newSaveArray] forKey:[NSString stringWithFormat:@"%@epubBookName",[[CatalogText siged] getBookName]]];
            
        }else{
        
            [oldSaveArray addObject:eMark];
            [[NSUserDefaults standardUserDefaults] setObject:[NSKeyedArchiver archivedDataWithRootObject:oldSaveArray] forKey:[NSString stringWithFormat:@"%@epubBookName",[[CatalogText siged] getBookName]]];
        }
